...
// Global variables
const canvas = document.getElementById('hw02_2018122055');
...
function initWebGL() {
    ...
    canvas.width = 600; // condition 1) Initial canvas size should be 600 x 600
    canvas.height = 600; // condition 1) Initial canvas size should be 600 x 600
